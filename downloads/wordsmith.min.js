...
(function(b){function i(){d&&d.remove();j=d=null}var d,j,a,e,f=!1;b.fn.wordsmith=function(m){a=b.extend({maxWordLength:18,popupWidth:600,popupHeight:400,lookupImage:"http://getwordsmith.co/images/Question_Mark.png",lookupMessage:"Lookup definition",lookupUrl:"https://en.wikipedia.org/wiki/{word}"},m);b(document).on("mouseup",function(){f||i();f=!1});b(document).scroll(function(){f||i();f=!1});this.on("mouseup",function(n){var c;c="";window.getSelection?c=window.getSelection():document.getSelection?
